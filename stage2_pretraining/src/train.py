...
#
# PATCHED FOR: Single GPU Windows training (no NCCL/DDP required)
...
def main(args, resume_preempt=False):
    ...
    # -- PATCHED: Skip DDP wrapping on Windows (no NCCL support)
    # encoder and predictor run as plain nn.Module on single GPU
